...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Práctica3 Héctor Hernández", nullptr, nullptr);
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//view = glm::translate( view, glm::vec3( screenWidth / 2, screenHeight / 4,-1000.0f ) ); // use with orthographic projection
		...
		model = glm::rotate(model, 40.0f, glm::vec3(1.0f, 1.0f, 1.0f));
		model = glm::scale(model, glm::vec3(4.0f, 4.0f, 4.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
